...
service: 'gmail',
auth: {
user: process.env.EMAIL_USER || '[tuemail@gmail.com](mailto:tuemail@gmail.com)',
...
if (diasDiferencia < 1) {
  ...
  return res.status(400).json({
    error: 'La reserva debe hacerse con 1 día de anticipación'
  });
...
if (
  ...
  return res.status(400).json({
    error: 'No se permiten reservas en fines de semana'
  });
